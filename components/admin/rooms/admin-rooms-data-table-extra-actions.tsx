...
export interface AdminRoomsDataTableExtraActionsProps {
  handleSyncDatabase: () => void
  isSyncDatabaseLoading?: boolean
}

const AdminRoomsDataTableExtraActions: React.FC<AdminRoomsDataTableExtraActionsProps> = (props) => {
...
export default AdminRoomsDataTableExtraActions
