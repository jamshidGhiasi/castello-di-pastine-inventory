...
const BottomNavigation = () => {
    ...
    return (
        <div className="fixed bottom-0 sm:bottom-10  left-1/2 -translate-x-1/2 flex items-center justify-between w-full sm:w-auto  backdrop-blur-2xl dark:border-neutral-800 dark:bg-neutral-900/30  border border-gray-50 p-1 sm:p-4 sm:rounded-lg z-10">
